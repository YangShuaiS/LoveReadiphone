...
- (void)hideTabBadgeBackgroundSeparator {
    ...
    self.tabBar.layer.shadowOffset = CGSizeMake(0,0);//shadowOffset阴影偏移,x向右偏移4，y向下偏移4，默认(0, -3),这个跟shadowRadius配合使用
    self.tabBar.layer.shadowRadius = 6.8;
    self.tabBar.layer.shadowOpacity = 0.17;
}
