...
- (void)didLastCellRelowFrom{
    self.transform = CGAffineTransformIdentity;
    if ([self.cell_delegate respondsToSelector:@selector(cardViewCellDidLastCellFromSuperView:)]) {
        [self.cell_delegate cardViewCellDidLastCellFromSuperView:self];
    }
}
