...
- (void)drawRect:(CGRect)rect {
    UIImage *norImage = [UIImage imageNamed:@"star_gary"];
    UIImage *selImage = [UIImage imageNamed:@"star_yellow"];
    // 图片没间隙自己画
...
- (void)touchesEnded:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event {
    ...
    if (self.guwen) {
        ...
        NSString *str = [NSString stringWithFormat:@"%lu",(unsigned long)self.index];
        self.guwen(str);
    }
