...
-(void)setupUI{
    ...
    LongAn = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGBA(255,255,255,0.9) LabelFont:TextFont(17) TextAlignment:NSTextAlignmentCenter Text:@"（2个正确答案）"];
