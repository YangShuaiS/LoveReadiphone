...
//        [panGesture addTarget:self action:@selector(longPressGestureRecognized:)];
...
//    UIPanGestureRecognizer *longPress = (UIPanGestureRecognizer *)sender;
    ...
    longPress.minimumPressDuration = 0.5;//(2秒)
    //手指在tableView中的位置
...
- (void)cellSelectedAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [UIView animateWithDuration:0.00001 animations:^{
        self->_snapshot.transform = CGAffineTransformMakeScale(0.9, 0.9);
