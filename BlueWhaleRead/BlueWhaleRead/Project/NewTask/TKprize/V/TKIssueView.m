...
- (void)addview{
    ...
    flowLayout.itemSize = CGSizeMake(LENGTH(67),LENGTH(97));
    ...
    [collectview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(LENGTH(97)+LENGTH(20));
    }];
...
- (void)setModel:(TKPWQpastLottery1InfoModel *)model{
    ...
    [self mas_updateConstraints:^(MASConstraintMaker *make) {
        make.height.mas_equalTo(LENGTH(97)*i+LENGTH(14)*(i-1)+LENGTH(20));
    }];
