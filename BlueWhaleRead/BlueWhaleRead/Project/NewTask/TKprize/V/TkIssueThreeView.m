...
@implementation TkIssueThreeView{
...
- (void)addview{
    ...
    flowLayout.itemSize = CGSizeMake(LENGTH(55),LENGTH(78));
    ...
    [collectview mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_equalTo(LENGTH(78)+LENGTH(20));
    }];
...
- (void)setModel:(TKPWQpastLottery1InfoModel *)model{
    ...
    [self mas_updateConstraints:^(MASConstraintMaker *make) {
        make.height.mas_equalTo(LENGTH(78)*i+LENGTH(14)*(i-1)+LENGTH(20));
    }];
