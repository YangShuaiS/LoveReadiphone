...
//    self.collectionView.frame = self.bounds;
    ...
    if(self.collectionView.contentOffset.x == 0 && _totalItems > 0)
    {
        ...
        //设置图片默认位置
        [self.collectionView scrollToItemAtIndexPath:[NSIndexPath indexPathForRow:targeIndex inSection:0] atScrollPosition:UICollectionViewScrollPositionCenteredHorizontally animated:YES];
...
- (void)scrollViewWillBeginDecelerating: (UIScrollView *)scrollView{
    ...
    NSInteger interrow = currentIndex + _dragDirection;
    if (interrow<array.count) {
            [self.collectionView scrollToItemAtIndexPath:[NSIndexPath indexPathForRow:interrow inSection:0] atScrollPosition:UICollectionViewScrollPositionCenteredHorizontally animated:YES];
    }else{
