...
@implementation GuiDeZhiShiWangTwoView
...
- (void)setViewy:(CGFloat)viewy{
    ...
    [xian mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(ws).with.offset(viewy+LENGTH(43)+LENGTH(162)*0.610561+LENGTH(15)+LENGTH(14)+LENGTH(17));
    ...
    BaseLabel * title = [[BaseLabel alloc] initWithFrame:CGRectMake(0, 0, 0, 0) LabelTxteColor:RGB(255, 255, 255) LabelFont:TextFont(15) TextAlignment:NSTextAlignmentLeft Text:@"这里是你浏览过的所有知识图哦～"];
...
- (void)addArc {
    ...
    //镂空
    UIBezierPath *circlePath = [UIBezierPath bezierPathWithRect:CGRectMake(0, _viewy, WIDTH, LENGTH(43)+LENGTH(162)*0.610561+LENGTH(15)+LENGTH(14)+LENGTH(17))];
    //    [circlePath stroke];
