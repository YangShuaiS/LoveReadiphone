//
//  SearchbannerdataTableViewCell.m
//  BlueWhaleRead
//
...
@implementation SearchbannerdataTableViewCell{
    SearchRelatedView * view;
}
...
- (void)setItemarray:(NSMutableArray *)itemarray{
    ...
    CGFloat height = LENGTH(51) + LENGTH(88)*inter;
