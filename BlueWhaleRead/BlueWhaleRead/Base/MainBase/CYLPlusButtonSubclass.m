...
- (void)layoutSubviews {
    ...
    CGFloat const imageViewEdgeWidth   = 35;
    CGFloat const imageViewEdgeHeight  = 40;
    ...
    self.imageView.center = CGPointMake(centerOfView, 27);

    //title position 位置
    self.titleLabel.bounds = CGRectMake(0, 0, self.bounds.size.width, labelLineHeight);
    self.titleLabel.center = CGPointMake(centerOfView, 54);
}
...
+ (id)plusButton {
    ...
    UIImage *normalButtonImage = [UIImage imageNamed:@"知识网1"];
    UIImage *hlightButtonImage = [UIImage imageNamed:@"知识网"];
    [button setImage:normalButtonImage forState:UIControlStateNormal];
    [button setImage:hlightButtonImage forState:UIControlStateSelected];
    UIImage *normalButtonBackImage = [UIImage imageNamed:@"daohang"];
    ...
    button.titleLabel.font = [UIFont fontWithName:@"PingFangSC-Medium" size:FontSize(10)];
    [button setTitle:@"知识网" forState:UIControlStateNormal];
    [button setTitleColor:[UIColor grayColor] forState:UIControlStateNormal];
    [button setTitleColor:TabBarTitleColor forState:UIControlStateSelected];

    [button sizeToFit]; // or set frame in this way `button.frame = CGRectMake(0.0, 0.0, 250, 100);`
    button.frame = CGRectMake(0.0, 0.0, 55, 70);
...
+ (UIViewController *)plusChildViewController {
    ...
    UIViewController *plusChildNavigationController = [[BaseNavigationViewController alloc]
